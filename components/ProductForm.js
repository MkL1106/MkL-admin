...
return(
            ...
            <label className="">Бүтээгдэхүүний нэр</label>
            <input 
            type="text" 
            ...
            <div className="mb-2 flex flex-wrap gap-1">
                ...
                <label className="w-24 h-24 cursor-pointer text-center
                    flex flex-col items-center justify-center text-cm gap-1
            ...
            <label>Үнэ (₮)</label>
            <input type="text" placeholder="Үнэ" value={price}onChange={ev => setPrice(ev.target.value)}/>
            <button type="submit" className="btn-primary display: block">Хадгалах</button>
            </form>
    );
}